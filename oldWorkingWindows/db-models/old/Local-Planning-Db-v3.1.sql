...
CREATE TABLE IF NOT EXISTS `PlanningDB`.`Reservation_Event` (
  ...
  `reservationUUID` VARCHAR(45) NULL,
  `eventUUID` VARCHAR(45) NOT NULL,
...
START TRANSACTION;
USE `PlanningDB`;
INSERT INTO `PlanningDB`.`BaseEntity` (`entityId`, `entity_version`, `active`, `timestamp`, `timestampLastUpdated`, `timestampCreated`) VALUES (1, 1, 1, DEFAULT, NULL, NULL);
INSERT INTO `PlanningDB`.`BaseEntity` (`entityId`, `entity_version`, `active`, `timestamp`, `timestampLastUpdated`, `timestampCreated`) VALUES (2, 1, 1, DEFAULT, NULL, NULL);
INSERT INTO `PlanningDB`.`BaseEntity` (`entityId`, `entity_version`, `active`, `timestamp`, `timestampLastUpdated`, `timestampCreated`) VALUES (3, 1, 1, DEFAULT, NULL, NULL);
INSERT INTO `PlanningDB`.`BaseEntity` (`entityId`, `entity_version`, `active`, `timestamp`, `timestampLastUpdated`, `timestampCreated`) VALUES (4, 1, 1, DEFAULT, NULL, NULL);
INSERT INTO `PlanningDB`.`BaseEntity` (`entityId`, `entity_version`, `active`, `timestamp`, `timestampLastUpdated`, `timestampCreated`) VALUES (5, 1, 1, DEFAULT, NULL, NULL);
INSERT INTO `PlanningDB`.`BaseEntity` (`entityId`, `entity_version`, `active`, `timestamp`, `timestampLastUpdated`, `timestampCreated`) VALUES (6, 1, 1, DEFAULT, NULL, NULL);
