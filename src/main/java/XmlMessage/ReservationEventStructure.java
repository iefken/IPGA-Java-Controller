...
@XmlType(propOrder = { "uuid","userUuid", "eventUuid", "reservationType", "paid", "entityVersion", "active", "timestamp" })
public class ReservationEventStructure {
	...
	public ReservationEventStructure() {
