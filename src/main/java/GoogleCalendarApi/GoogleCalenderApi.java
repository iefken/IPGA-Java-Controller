...
public class GoogleCalenderApi {
    ...
    private static final java.io.File DATA_STORE_DIR = new java.io.File(
            System.getProperty("user.home"), ".credentials/calendar-integration-groupA-java");
    ...
    public static void listEvents(com.google.api.services.calendar.Calendar service)throws IOException
    {
