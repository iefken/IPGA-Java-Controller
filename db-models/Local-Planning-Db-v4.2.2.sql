...
-- Schema PlanningDB
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `PlanningDB` DEFAULT CHARACTER SET utf8 ;
USE `PlanningDB` ;
...
-- -----------------------------------------------------
-- Table `PlanningDB`.`Task`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PlanningDB`.`Task` (
  ...
  `timestampCreated` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`idTask`),
  INDEX `fk_event_uuid_idx` (`eventUuid` ASC),
  INDEX `fk_uuid_idx` (`uuid` ASC),
  INDEX `fk_entityId_task` (`idTask` ASC),
  CONSTRAINT `fk_Task_BaseEntity1`
    FOREIGN KEY (`idTask`)
    REFERENCES `PlanningDB`.`BaseEntity` (`idBaseEntity`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `PlanningDB`.`Assign_Task`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PlanningDB`.`Assign_Task` (
  `idAssignTask` INT(10) UNSIGNED NOT NULL,
  `uuid` VARCHAR(45) NULL,
  `userUuid` VARCHAR(45) NULL,
  `taskUuid` VARCHAR(45) NULL,
  `timestampLastUpdated` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP  ON UPDATE CURRENT_TIMESTAMP,
  `timestampCreated` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`idAssignTask`),
  INDEX `fk_eventUuid_assigntask_idx` (`uuid` ASC),
  INDEX `fk_taskUuid_assignTask_idx` (`taskUuid` ASC),
  INDEX `fk_userUuid_assignTask_idx` (`userUuid` ASC),
  CONSTRAINT `fk_entityId_assigntask`
    FOREIGN KEY (`idAssignTask`)
    REFERENCES `PlanningDB`.`BaseEntity` (`idBaseEntity`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_taskUuid_assignTask`
    FOREIGN KEY (`taskUuid`)
    REFERENCES `PlanningDB`.`Task` (`uuid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_userUuid_assignTask`
    FOREIGN KEY (`userUuid`)
    REFERENCES `PlanningDB`.`User` (`uuid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
